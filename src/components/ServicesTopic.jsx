      ...
      <div className="mx-auto max-w-2xl lg:max-w-none">
        <div className="max-w-2xl" style={{ opacity: 1, transform: "none" }}>
          ...
          <div className="mt-6 text-xl text-neutral-600">
            <p>
            As long as those opportunities involve partnering with DigixTech to amplify your tech skills — we can create an endless array of transformative experiences.
            </p>
          </div>
        </div>
      </div>
